...
#define BUF_SIZE_BIT 9 // 511 max

struct fifo_s
{
  unsigned int head : BUF_SIZE_BIT;
  unsigned int tail : BUF_SIZE_BIT;
  unsigned int filling : BUF_SIZE_BIT;
  void        *buffer;
  unsigned int size : BUF_SIZE_BIT; 
